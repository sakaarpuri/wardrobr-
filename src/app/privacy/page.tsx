  ...
  return (
    <div className="min-h-screen bg-[#0C0A09] text-white">
      ...
      <main className="max-w-2xl mx-auto px-6 py-16">
        <h1 className="font-display italic text-4xl text-white mb-2">Privacy Policy</h1>
        <p className="text-white/35 text-sm mb-12">Last updated: 29 March 2026</p>

        <div className="space-y-10 text-white/70 text-sm leading-relaxed">

          <section>
            <h2 className="text-[#EDE0CE] text-base font-semibold mb-3">1. Who we are</h2>
            <p>
          ...
          <section>
            <h2 className="text-[#EDE0CE] text-base font-semibold mb-3">2. What information we collect</h2>
            <p className="mb-3">We collect only what is necessary to provide the styling service:</p>
            <ul className="list-disc list-inside space-y-2 text-white/60">
              <li><strong className="text-white/80">Style requests</strong> — the text, images, or voice input you submit to get outfit recommendations.</li>
              <li><strong className="text-white/80">Usage data</strong> — standard server logs (page views, browser type, IP address) collected automatically.</li>
              <li><strong className="text-white/80">Preferences</strong> — size, gender, and budget preferences you optionally provide within a session.</li>
            </ul>
            <p className="mt-3">
              We do <strong className="text-white/80">not</strong> require account registration. We do not collect your name or email address unless you contact us directly.
            </p>
          </section>

          <section>
            <h2 className="text-[#EDE0CE] text-base font-semibold mb-3">3. How we use your information</h2>
            <ul className="list-disc list-inside space-y-2 text-white/60">
          ...
          <section>
            <h2 className="text-[#EDE0CE] text-base font-semibold mb-3">4. Affiliate links &amp; third parties</h2>
            <p className="mb-3">
            ...
            <ul className="list-disc list-inside space-y-2 text-white/60">
              <li><strong className="text-white/80">Sovrn Commerce (Viglink)</strong> — affiliate link management. <a href="https://sovrn.com/privacy-policy/" target="_blank" rel="noopener noreferrer" className="text-[#E8A94A] hover:underline">Their privacy policy</a>.</li>
              <li><strong className="text-white/80">Skimlinks</strong> — affiliate link management. <a href="https://skimlinks.com/privacy-policy/" target="_blank" rel="noopener noreferrer" className="text-[#E8A94A] hover:underline">Their privacy policy</a>.</li>
              <li><strong className="text-white/80">Google Gemini</strong> — AI processing of your style requests. <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[#E8A94A] hover:underline">Google's privacy policy</a>.</li>
            </ul>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-[#EDE0CE] text-base font-semibold mb-3">5. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="text-[#EDE0CE] text-base font-semibold mb-3">6. Data retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-[#EDE0CE] text-base font-semibold mb-3">7. Your rights (UK GDPR)</h2>
          ...
          <section>
            <h2 className="text-[#EDE0CE] text-base font-semibold mb-3">8. Changes to this policy</h2>
            <p>
